    ...
    <section id="contact" style={{ background: "#FFFFFF" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "60px" }}>
        ...
        <motion.div
          ...
          <h2 style={{ fontSize: "2.4rem", fontWeight: "800", color: "#222222", marginBottom: "24px", lineHeight: 1.2 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {[
              ...
              <a key={c.label} href={c.href} target="_blank" rel="noreferrer" style={{
                ...
                padding: "16px", background: "#F8F8F8", border: "1px solid #ebebeb",
                ...
                <div>
                  <p style={{ fontSize: "0.7rem", color: "#7B7B7B", letterSpacing: "1px", textTransform: "uppercase" }}>{c.label}</p>
                  <p style={{ fontSize: "0.88rem", fontWeight: "600", marginTop: "2px" }}>{c.value}</p>
                </div>
              </a>
            ))}
          </div>
